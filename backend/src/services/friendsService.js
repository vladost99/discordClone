...
class FriendService {
  async invite({ receive_mail, sender_user }) {
    if (receive_mail === sender_user.mail)
      throw FriendsError.InvitationYourself();
    ...
    const usersAlreadyFriends = targetUser.friends.find(
      (friendId) => friendId.toString() === sender_user._id.toString()
    );
    ...
    await friendsUpdateSocket.updatePendingInvitations(
